    ...
    <div className="flex min-h-[90vh] items-center justify-center bg-white dark:bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full flex flex-col lg:flex-row items-center justify-between gap-8 rounded-lg py-8">
        ...
        <div className="flex-1 w-full basis-3/5 space-y-4">
          ...
          <div className="flex gap-4 text-sm text-gray-800 dark:text-gray-300">
          ...
          <div className="flex gap-2">
            <Button variant="secondary" size="icon" className="size-8 text-black dark:text-white border-black dark:border-white">
              <Linkedin />
            </Button>
            <Button variant="secondary" size="icon" className="size-8 text-black dark:text-white border-black dark:border-white">
              <GithubIcon />
        ...
        <div className="flex-1 basis-2/5 flex justify-center">
          <Avatar className="h-48 w-48 border border-black dark:border-white shadow-lg">
            ...
            <AvatarFallback className="text-black dark:text-white">PS</AvatarFallback>
          </Avatar>
        </div>
      </div>
    </div>
